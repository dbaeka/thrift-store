...
export function PrimaryButton(props: any) {
    const classes = `w-full flex items-center justify-center px-8 py-2 border border-transparent text-base font-medium rounded-md text-white bg-lilac-600 hover:bg-lilac-700 md:text-lg md:px-3 ${props.additionalClasses}`;
    return (
